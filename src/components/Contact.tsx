    ...
    <section id="contact" className="py-16 sm:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-lg mx-auto">
          {/* Contact Form */}
          {/* Add netlify attribute for Netlify forms, or implement custom handler */}
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center rounded-md border border-transparent bg-primary px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors duration-200"
              >
                Send Message
              </button>
            </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center space-x-6">
              <a href="https://github.com/yourusername" /* Replace */ target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-primary transition-colors duration-200">
                <span className="sr-only">GitHub</span>
                <GitHubIcon />
              </a>
              <a href="https://linkedin.com/in/yourusername" /* Replace */ target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-primary transition-colors duration-200">
