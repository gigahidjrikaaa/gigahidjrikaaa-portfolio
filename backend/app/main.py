...
from .api import auth, projects, admin, experience, education, skills, contact, awards, certificates, services, blog, profile, testimonials, comments, seo, scraper, press_mentions, clients, stories, analytics, portfolio_export, github_repos
...
# Admin-prefixed routes (write operations, require auth)
...
app.include_router(github_repos.public_router, prefix=f"{settings.API_V1_STR}/github-repos", tags=["github-repos"])
app.include_router(github_repos.admin_router, prefix=f"{settings.API_V1_STR}/admin/github-repos", tags=["github-repos"])
