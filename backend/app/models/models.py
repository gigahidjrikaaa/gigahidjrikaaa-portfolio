...
class Certificate(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    title = Column(String, nullable=False)
    certificate_type = Column(String(50), nullable=False, default="technical")
    custom_type_label = Column(String(120), nullable=True)
    issuer = Column(String, nullable=True)
    authority = Column(String(200), nullable=True)
    issue_date = Column(String, nullable=True)
    expiry_date = Column(String, nullable=True)
    credential_status = Column(String(50), nullable=True)
    credential_id = Column(String, nullable=True)
    credential_url = Column(String, nullable=True)
    specialization = Column(String(200), nullable=True)
    level = Column(String(100), nullable=True)
    result = Column(String(120), nullable=True)
    learning_hours = Column(Integer, nullable=True)
