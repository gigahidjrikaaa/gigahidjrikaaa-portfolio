...
import { XMarkIcon, BriefcaseIcon, MapPinIcon, CalendarIcon } from '@heroicons/react/24/outline';
            ...
            <div className="relative bg-white px-6 sm:px-8 py-5 sm:py-6 text-gray-900 border-b border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-base sm:text-lg text-gray-600">{experience.company}</p>
